...
- **Recording consent.** You are responsible for complying with the recording-consent laws of the jurisdiction in which you record. Many jurisdictions require notice to all participants of a conversation; some require explicit consent from all parties. Asleep makes no representation that any specific recording you make is lawful.
- **No unlawful content.** Do not use the app to capture, transcribe, store, or transmit content that you are not legally entitled to record, retain, or distribute.
- **No abuse.** Do not interfere with the operation of the app, attempt to bypass its security mechanisms, or use it in a way that violates the terms of any third-party service it connects to (Google, OpenAI, Notion, etc.).
